...
<body>
		...
		<?php 
			...
			if($_SERVER["REQUEST_METHOD"]=='POST'){
			    ...
			    $disabled="disabled";
			       ...
			       echo "<h4>Phone Number: {$customer['phno']}</h4>";
	...
	<div class="container center">
		<a href="transfer.php" style="background-color: grey; margin: 20px;" class="btn-1" <?php if($insufficient) { echo $disabled;} ?>>Transfer to &rarr;</a>
